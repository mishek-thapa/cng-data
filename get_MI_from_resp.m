function [I, Hsig, Hnoise] = get_MI_from_resp(spikes,bins,word_size,starts)
...
T=uint32(length(bins)-word_size); %number of time windows to average over in sliding time window
